...
def plotEquatorialDensityProfile(filenames, ylims=[-1e-6, 1e-6], tol=1e-3):
    """
    Produces a plot of the density profile for the Be star disk.
    ...
    #    print p
        ...
        plt.scatter(np.log10(Rs), np.log10(rhos), s=0.75, color=ylims[0]) #label=ylims[1] +"gradient = {:.3}".format(p[0]))
        #plt.plot(np.log10(Rs), p[0] * np.log10(Rs) + p[1], color='r')
    #    plt.xlim(0, 1.5)
    #    plt.ylim(ylims[0], ylims[1])
        plt.xlabel("Distance from centre of Be star in Be radii")
...
plotDensityProfileFromPartNumbers(['../../Desktop/40d_0.0e_eqTest/QGDISK38101',
                                   '../../Desktop/40d_0.0e_eqTest/QGDISK38102',
                                   '../../Desktop/40d_0.0e_eqTest/QGDISK38103',
                                   '../../Desktop/40d_0.0e_eqTest/QGDISK38104',
                                   '../../Desktop/40d_0.0e_eqTest/QGDISK38105',], [2, 25], 100)
...
#plotPowerLawWindowWithR('/data/rob1g10/SPH/DATA/DISKS/40d_0.0e_eqTest/processedDISKs/QGDISK38701', [2, 15], 50)
